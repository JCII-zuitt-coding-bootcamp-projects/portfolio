			    ...
			    <section className="modal-card-body has-text-black">
					...
					<h6 className="title is-6 has-text-grey">
			   		...
			   		<p>
			   			...
			   			EyeSecure is my 3rd project I developed in <a href="https://zuitt.co/" target="_blank">Zuitt Coding Bootcamp</a>.
			   			It was developed using MERN stack(MongoDB, Express. js, React, and Node. js) , Apollo graphql and many cool Javascript libraries.
			   			The project was inspired by what <a href="https://www.youtube.com/watch?v=CLo3e1Pak-Y" target="_blank">China's facial recognition technology (AI) </a>they have today.
			   			Basically Eyesecure is a facial recognition technology for CCTV cameras that can be used probably in CCTV cameras control room.
			   			Admins will feed<a href="https://www.youtube.com/watch?v=HcqpanDadyQ" target="_blank">(machine learning)</a> the system the faces of the person they want to monitor and once recorded face is detected, it will saved automatically in the recent detections.
			   			They can also add person in the watchlist and once their face where detected, the system will alarm.			
					</p>
			   		...
			   		<p>
			   			...
			   			<br/>
			   				<ol className="has-text-justified" style={{ margin: '0 1rem'}}>
				   				...
				   				<li>
				   					Go to "Admin" section to Add, Edit or delete Admins.
				   				</li>
								...
								<li>
				   				...
				   				<li>
									After adding person profile, Click the "EyeSecure Icon" in the middle of the Navigation bar to start Face recognition.
				   				</li>
				   				...
				   				<li>
									If you don't want to test your own face in live detection, You can test live detection by using your phone (search for the celebrity photo with their faces) and put it in front of the Web Cam.
				   				</li>
			   		...
			   		<p>
			   			...
			   			<br/>
			   				<ol className="has-text-justified" style={{ margin: '0 1rem'}}>
				   				...
				   				<li>
				   					The App is hosted on <a href="https://www.heroku.com/" target="_blank">Heroku</a> (free web hosting site, which is ideal for simple web app).
				   					If the website did not load properly or show some error, try to reload the website many times.
				   					Because of these, the system may load slower for rendering and fetching of necessary data. Contact me if you encountered any problem.
				   				</li>
				   				...
				   				<li>
				   					The system needs a decent webcam(to mimic CCTV camera) to test live facial recognition.
				   				</li>
