			    ...
			    <section className="modal-card-body has-text-black">
					...
					<h6 className="title is-6 has-text-grey">
			   		...
			   		<p>
			   			...
			   			Recipinoy is my 1st project I developed in <a href="https://zuitt.co/" target="_blank">Zuitt Coding Bootcamp</a>. The goal of the 1st project is to showcase our skills in creating static websites using HTML, CSS(Bootstrap) and Javascript. Recipinoy is a website of Pinoy recipes. The website is mobile responsive.
					</p>
